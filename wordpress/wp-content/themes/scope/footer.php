            ...
            <div class="container">
                <div class="row justify-content-center">
	                <div class="col-6 footer-copy text-center">
	                    <p>&copy; <?php echo esc_html(date_i18n(__('Y', 'scope'))).' '; bloginfo( 'name' ); ?> | <?php printf( esc_html__( 'Millville NJ 08332 %1$s', 'ILGC' ),  '<a href="'.esc_url('https://www.lagrancanaan.tk').'" rel="designer"ILGC</a>' ); ?></p>
	                </div>
                </div>
            </div>
        </div>
