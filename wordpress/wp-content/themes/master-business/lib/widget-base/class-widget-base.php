 ...
 * @since 1.0.0
 */
class Master_Business_Widget_Base extends WP_Widget {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'master-business' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'master-business' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'master-business' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove Button', 'master-business' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
					...
					<?php $this->render_description( $field, $this->get_field_id( $key ) ); ?><br/>
				</div>
				<?php
				break;
